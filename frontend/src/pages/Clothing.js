  ...
  const loadClothing = async () => {
    ...
    try {
      const url = selectedCategory === 'all' 
        ...
        : `http://localhost:5000/api/clothing?category=${selectedCategory}`;
      ...
      setError('Unable to connect to our clothing collection');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        background: `
          ...
          url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1920&h=800&fit=crop&crop=center') center/cover no-repeat
        `,
        color: 'white',
        marginBottom: '80px',
        position: 'relative',
        ...
        <div style={{ position: 'relative', zIndex: '2', maxWidth: '900px' }}>
          ...
          <p style={{ 
            ...
            Premium clothing that defines style and comfort for every occasion
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            Showing {clothing.length} clothing items
          </div>
        </div>
